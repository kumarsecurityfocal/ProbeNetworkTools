...
// A completely simplified token management component that avoids
// using problematic DOM operations that cause the toLowerCase error
const TokenManager = () => {
  // Form state
