...
// Setup log directory
const LOG_DIR = '/opt/probeops/logs';
try {
...
app.listen(PORT, '0.0.0.0', () => {
  const startMessage = `ProbeOps enhanced server running on port ${PORT}`;
